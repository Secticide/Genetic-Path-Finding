...
CGPrincipleAxesObject::CGPrincipleAxesObject()
{
	// setup shader for principle axes
	GLSL_ERROR glsl_err = GLSLFactory::createShaderProgram(string("Resources\\shaders\\Default.vs"), string("Resources\\Shaders\\Default.fs"), &paShader);
...
void CGPrincipleAxesObject::render(const GUMatrix4& T)
{
